...
- Publish 0.1.1 first as a clearly labeled direct-download preview. The app's manual update command remains visible and reports an error while the intentionally absent production feed is not yet activated.
