...
The fixed hardened update feed is active and currently serves Ushot 0.1.11 (build 12):

```text
https://ischeneycc.github.io/ushot/updates/v1/appcast.xml
```

Ushot 0.1.11 (build 12) is the current published release. Protected run [`32979927495`](https://github.com/isCheneycc/ushot/actions/runs/32979927495) completed all 11 jobs with `publish_update_feed=true`, published and anonymously verified exactly five immutable assets, independently signed its archive, and extended the authenticated production feed while retaining 0.1.10 and the earlier signed history.
...
The immutable published [`v0.1.11`](https://github.com/isCheneycc/ushot/releases/tag/v0.1.11) GitHub Release (id `377210305`, published `2026-08-26T14:31:19Z`) contains exactly the following:

```text
Ushot-0.1.11-arm64.dmg
Ushot-0.1.11-arm64.zip
Ushot-0.1.11-arm64.dSYM.zip
Ushot-0.1.11-arm64.release-manifest.json
SHA256SUMS.txt
```

Protected workflow run [`32979927495`](https://github.com/isCheneycc/ushot/actions/runs/32979927495) attempt 1 completed all 11 jobs on 2026-08-26 with `publish_update_feed=true`. Release PR [`#24`](https://github.com/isCheneycc/ushot/pull/24) and exact protected-main CI push run [`32979335120`](https://github.com/isCheneycc/ushot/actions/runs/32979335120) preceded the immutable tag; annotated tag object `e5700abf6280e29246a3949332dc0e0ef0b3ecc3` peels to commit `bdfeddef5447746e55fde33b08f1a9fe500adf09`. The exact public files are:

| Asset | Bytes | SHA-256 |
| --- | ---: | --- |
| `Ushot-0.1.11-arm64.dmg` | 4,673,194 | `ef8ac4f92e4e9d9fb15340eb19c87b977ecee38b03e517e6feea15b7f65f3b1e` |
| `Ushot-0.1.11-arm64.zip` | 4,229,899 | `827b13d5f67a9006112a794cdecd36d97df706d7af62eff54260af8b8dbb9942` |
| `Ushot-0.1.11-arm64.dSYM.zip` | 5,986,302 | `279e0b08198f267e3782832227c6d21ed6e16f0109c20a62ce31079d7d40f26a` |
| `Ushot-0.1.11-arm64.release-manifest.json` | 896 | `7253beb2732c9c0c74c3bd60035032ec3d3bff6ec61437447e384b5384f9ff46` |
| `SHA256SUMS.txt` | 379 | `e49b9af7ba987a891cbaad8bbc4d2ff4358d3187424f73200ea80e4507ebdabd` |

The workflow and a separate anonymous post-publication download both validated that exact five-asset set, including the complete ZIP/dSYM/DMG/manifest validator. Authenticated-appcast artifact `9611266086` has REST digest `sha256:4e037891c3c276a2531c04645f751b566243620a79547b4f86805968b58ed94c`; Pages artifact `9611288452` has REST digest `sha256:c223b40eab0c515ac715b21d10ea3ea4fcbe6821561f9b556afe290594a6132e`. Their appcast XML and the live 7,364-byte feed match byte-for-byte at SHA-256 `6795884faf213cb931f57d1d6425959a2229f119c8efad7e74b5318f5ecc13db`; its identities are exactly 0.1.11/12, 0.1.10/11, 0.1.9/10, 0.1.6/7 and 0.1.5/6, while direct-download-only 0.1.7/0.1.8 remain absent. Credential-free Ed25519 verification and tamper rejection passed. Pages deployment `6106000652` reached success status `17365421395` at `2026-08-26T14:33:35Z`, and the legacy endpoint remains HTTP 404. The `release`, `update-feed-signing` and `github-pages` environment allowlists each admit only exact tag `v0.1.11`; repository, `release` and `github-pages` have zero secrets, and only `update-feed-signing` contains the unchanged `SPARKLE_ED25519_PRIVATE_KEY` secret.
