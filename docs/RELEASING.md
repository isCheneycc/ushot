...
```text
Ushot-0.1.14-arm64.dmg
Ushot-0.1.14-arm64.zip
Ushot-0.1.14-arm64.dSYM.zip
Ushot-0.1.14-arm64.release-manifest.json
SHA256SUMS.txt
```

Protected workflow run [`34350744616`](https://github.com/isCheneycc/ushot/actions/runs/34350744616) attempt 1 completed all 11 jobs on 2026-09-09 with `publish_update_feed=true`. Release PR [`#30`](https://github.com/isCheneycc/ushot/pull/30) and exact protected-main CI push run [`34350041030`](https://github.com/isCheneycc/ushot/actions/runs/34350041030) preceded the immutable tag; annotated tag object `0bc70c1326bbfcb8b42bf8b36294182adf656b6d` peels to commit `5769e2e94909ea8cf25c4e8dc00afff286a70cc4`. The exact public files are:

| Asset | Bytes | SHA-256 |
| --- | ---: | --- |
| `Ushot-0.1.14-arm64.dmg` | 4,709,622 | `5a63881ac70bf8b82af980d8fd59cf0d5f333d98e6d8e73f09cc6582efca0e1e` |
| `Ushot-0.1.14-arm64.zip` | 4,288,362 | `05687e47e6b86f95e29838816a52fb5067175b6ccc8987f08bc95c8cde8988e1` |
| `Ushot-0.1.14-arm64.dSYM.zip` | 6,072,351 | `eeb36fbacbdce638f701922d49510092c21265dd38e0a106addc0ed72fc639c8` |
| `Ushot-0.1.14-arm64.release-manifest.json` | 896 | `b73b6e026c00774346a91d2ab30e75e8042407dbde09468b62504bef248de695` |
| `SHA256SUMS.txt` | 379 | `6ca47befb7251bbf962899fb3cd1e9107dd134cfd55fa8b59f4989d6941fca59` |
...
```text
Ushot-0.1.12-arm64.dmg
Ushot-0.1.12-arm64.zip
Ushot-0.1.12-arm64.dSYM.zip
Ushot-0.1.12-arm64.release-manifest.json
SHA256SUMS.txt
```

Protected workflow run [`33077486912`](https://github.com/isCheneycc/ushot/actions/runs/33077486912) attempt 1 completed all 11 jobs on 2026-08-27 with `publish_update_feed=true`. Release PR [`#26`](https://github.com/isCheneycc/ushot/pull/26) and exact protected-main CI push run [`33077007370`](https://github.com/isCheneycc/ushot/actions/runs/33077007370) preceded the immutable tag; annotated tag object `9e284e9b7cf1eb9173ee585b5f0a2afcb28bcae2` peels to commit `db180a77c561c0bc273c959f19dbf19195057754`. The exact public files are:

| Asset | Bytes | SHA-256 |
| --- | ---: | --- |
| `Ushot-0.1.12-arm64.dmg` | 4,676,233 | `e6d3936c9724c8bded475a195b084dd500fa7eafe1dbb37d4bcc1629bf4ae272` |
| `Ushot-0.1.12-arm64.zip` | 4,234,241 | `de2a937ba8bc241f3bec0885088938835390f259d859e580dcca500d81a3df46` |
| `Ushot-0.1.12-arm64.dSYM.zip` | 5,993,983 | `e1996ca4c43aac73120c62ece449db3ac6e3f37a9158c175e1610e5de253ac23` |
| `Ushot-0.1.12-arm64.release-manifest.json` | 896 | `b58ca9ef306a79d609c6893a5f38e837f2b6ee958c0713642d5e95732d32e647` |
| `SHA256SUMS.txt` | 379 | `7913f74fd8e29114fd710f38ee3f4dfe0f898677e744234ee3195e1ab723243f` |

The workflow and a separate anonymous post-publication download both validated that exact five-asset set, including the complete ZIP/dSYM/DMG/manifest validator. Authenticated-appcast artifact `9648699561` has REST digest `sha256:ef08a9f99a4671aaff4632f43fb6cb1194647e2b5f9efbde5e92efc18d89948c`; Pages artifact `9648723535` has REST digest `sha256:b25fd841daf624c65c321e1d2413b76c42ece63ef52ec9689311a4d8b7c4c847`. Their appcast XML and the live 7,372-byte feed match byte-for-byte at SHA-256 `04c2ea86e7ee71cd1d491c590cbe2bfb5441a00fbbefa7f728432829d993563b`; its identities are exactly 0.1.12/13, 0.1.11/12, 0.1.10/11, 0.1.9/10 and 0.1.6/7, while direct-download-only 0.1.7/0.1.8 remain absent. Credential-free runtime-policy validation passed, and the live feed was independently rebound to the exact authenticated artifact. Pages deployment `6123862702` reached success status `17411289221` at `2026-08-27T13:42:52Z`, and the legacy endpoint remains HTTP 404. The `release`, `update-feed-signing` and `github-pages` environment allowlists each admit only exact tag `v0.1.12`; repository, `release` and `github-pages` have zero secrets, and only `update-feed-signing` contains the unchanged `SPARKLE_ED25519_PRIVATE_KEY` secret.
